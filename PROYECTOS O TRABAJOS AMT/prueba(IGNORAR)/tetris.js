...
//    console.log("GAME OVER");
    ...
    gradient.addColorStop("0.14", "white");
    gradient.addColorStop("0.28", "gray");
    gradient.addColorStop("0.42", "gray");
...
Tetris.prototype.ranking = function() {
    ...
    for(var j=0;j<usuariosOrdenados.length;j++) {
        ...
        } else if (500<=puntos && puntos<0) {
            ctxRanking.fillStyle = 'orange';
        } else if (1000<=puntos && puntos<0) {
            ctxRanking.fillStyle = 'red';
        } else if (2500<=puntos && puntos<0) {
            ctxRanking.fillStyle = 'magenta';
        } else if (5000<=puntos && puntos<0) {
